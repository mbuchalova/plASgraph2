...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description=inspect.getdoc(inspect.getmodule(main_set)),
    ...
    cmd_set.add_argument("file_prefix",
                         help="common prefix to be used for all filenames listed in test_file_list, e.g. ../data/")
